...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    let offset = 0;
    let slideIndex = 0;
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i].querySelector('[data-slide="next"]')).click(evt => {
      evt.preventDefault();
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(this[i].querySelector('[data-slide="prev"]')).click(evt => {
      evt.preventDefault();
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(`#${sliderId} .carousel-indicators li`).click(evt => {
      evt.preventDefault();
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttribute = function (attribute, value) {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].tagName) {
      continue;
    }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleAttribute = function (attribute, value = '') {
  for (let i = 0; i < this.length; i++) {
    if (!this[i].tagName) {
      continue;
    }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.on = function (eventName, cb) {
  if (!eventName || !cb) {
    return this;
  }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.off = function (eventName, cb) {
  if (!eventName || !cb) {
    return this;
  }
